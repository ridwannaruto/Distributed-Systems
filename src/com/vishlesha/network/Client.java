        ...
        workerPool.submit(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    DatagramSocket clientSocket = GlobalState.getSocket();
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Socket socket = new Socket(request.getRecipientNode().getIpaddress(), request.getRecipientNode().getPortNumber());
